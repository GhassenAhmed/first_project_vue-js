app.component("display-product",{
    ...
    <div class="product-container">
      ...
      <div class="product-info">
        ...
        <button type="button" id="btn"  v-on:click="addToCart" :class="{disabledButton :quantity==0}"><span style="padding-right: 15px;">Ajoutez</span><i class="fa-sharp fa-solid fa-plus"></i></button>
    ...
    methods:{
        addReview(review){
            ...
            result(){
                ...
                this.resultat=parseInt(this.price)*parseInt(this.carts);
